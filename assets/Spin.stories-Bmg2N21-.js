...
在加载图标下方显示提示文字`,...s.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  name: '包裹模式 - 卡片加载',
  render: () => <div style={{
    display: 'flex',
    gap: '24px',
...
}`,...d.parameters?.docs?.source},description:{story:`包裹模式 - 卡片加载

在内容上方覆盖遮罩层，适用于加载表格、卡片等内容`,...d.parameters?.docs?.description}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  name: '包裹模式 - 表格加载',
  render: () => {
...
}`,...a.parameters?.docs?.source},description:{story:`包裹模式 - 表格加载

模拟实际业务中的表格加载场景`,...a.parameters?.docs?.description}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  name: '自定义提示文字',
  render: () => <div style={{
    display: 'flex',
    gap: '24px',
...
展示实际业务场景中的常见用法`,...p.parameters?.docs?.description}}};const z=["Playground","Basic","WithTip","WrapperMode","TableLoading","CustomTip","Combination"];export{n as Basic,p as Combination,l as CustomTip,i as Playground,a as TableLoading,s as WithTip,d as WrapperMode,z as __namedExportsOrder,j as default};
