...
@param visible 是否显示
@param e 关闭事件`},className:{required:!1,tsType:{name:"string"},description:"自定义类名"},style:{required:!1,tsType:{name:"CSSProperties"},description:"自定义样式"}}};const z={title:"反馈组件/Alert",component:s,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`Alert 警告提示组件 Storybook
