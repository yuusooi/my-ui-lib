...
@example "red" | "#ff0000" | "rgb(255, 0, 0)"`}}};const C={title:"布局/Divider",component:r,tags:["autodocs"],argTypes:{children:{control:"text",description:"分割线文字"},type:{control:"select",options:["horizontal","vertical"],description:"分割线方向"},dashed:{control:"boolean",description:"是否虚线"},orientation:{control:"select",options:["left","center","right"],description:"文字位置（仅水平方向有效）"},orientationMargin:{control:"text",description:`文字与边缘的距离（如：20px、100px、10%）
